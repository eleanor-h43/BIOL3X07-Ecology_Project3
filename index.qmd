...
Over the past decade, **Passive Acoustic Monitoring (PAM)** and advances in **Artificial Intelligence (AI)** have transformed ecological research, enabling scientists to monitor wildlife at unprecedented spatial and temporal scales. At the same time, ecosystems worldwide are experiencing increasingly frequent and severe disturbance events, with wildfires among the most significant. In Australia, **hazard-reduction (prescribed) burning** is widely used to reduce fuel loads, lower wildfire risk, and protect communities and infrastructure. It is also often promoted as a tool to maintain ecosystem health. Despite its widespread use, however, the short-term effects of prescribed fire on local wildlife remain poorly understood.

Birds are among the most effective indicators of ecosystem condition. Occupying a range of niches from the forest floor to above the canopy, eating everything from carrion and invertebrates to fruit and seeds, they perform critical ecological functions including pest control, pollination, seed dispersal, and bioturbation. Changes in bird communities can therefore provide valuable insights into how ecosystems respond to environmental change and disturbance.

This project investigates how hazard-reduction burning influences bird activity in the Greater Blue Mountains. Although the effects of fire on wildlife have been extensively studied, most research begins months or years after a fire has occurred. As a result, many studies can only compare burned and unburned sites after the disturbance. Ideally, ecologists would monitor both impacted and control sites before and after a fire using a well-replicated experimental design to gain a comprehensive understanding of the changes that have occurred at each site. Such studies are rare because they are often very difficult to implement in the field.
...
[Download site photos (PowerPoint)](https://github.com/eleanor-h43/BIOL3X07-Ecology_Project3/raw/refs/heads/main/images/site_images.pptx)
...
You can find scripts for code in the [Scripts folder](https://github.com/eleanor-h43/BIOL3X07-Ecology_Project3/tree/main/scripts) (we will add to this throughout the semester).
